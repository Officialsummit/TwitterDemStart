...
//TODO: user login
        ...
        StorageReference storageRef = storage.getReferenceFromUrl("gs://twitter-app-4063a.appspot.com");
...
// Create a reference to "mountains.jpg"
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                String url="http://192.168.10.12/twitterAndroidServer/register.php?first_name="+name+"&email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString()+"&picture_path="+ downloadUrl;
...
//login
                    String url="http://192.168.10.12/twitterAndroidServer/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;
